...
//
#define LOCALIZED_ALTERNATE_TRUE     L"prawda" // true ___
#define LOCALIZED_ALTERNATE_FALSE    L"fa?sz" // false ___
#define LOCALIZED_ALTERNATE_END      L"ju?" // end ___
...
#define LOCALIZED_ALTERNATE_BACK                   L"wstecz" // back ___
...
#define LOCALIZED_ALTERNATE_BK                     L"ws" // bk ___
...
#define LOCALIZED_ALTERNATE_CLEARSCREEN            L"czy??" // clearscreen ___
...
#define LOCALIZED_ALTERNATE_CS                     L"cs" // cs ___
...
#define LOCALIZED_ALTERNATE_FD                     L"np" // fd ___
#define LOCALIZED_ALTERNATE_FENCE                  L"fence" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_FILL                   L"zamaluj" // fill ___
...
#define LOCALIZED_ALTERNATE_FORWARD                L"naprz?d" // forward ___
...
#define LOCALIZED_ALTERNATE_HIDETURTLE             L"schowajmnie" // hideturtle ___
#define LOCALIZED_ALTERNATE_HOME                   L"home" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_HT                     L"s?" // ht ___
#define LOCALIZED_ALTERNATE_IF                     L"je?li" // if ___
#define LOCALIZED_ALTERNATE_IFELSE                 L"ifelse" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_IFF                    L"iff" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_IFFALSE                L"jesliNie" // iffalse ___
#define LOCALIZED_ALTERNATE_IFT                    L"ift" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_IFTRUE                 L"je?liTak" // iftrue ___
...
#define LOCALIZED_ALTERNATE_LABEL                  L"wpisztekst" // label ___
...
#define LOCALIZED_ALTERNATE_LEFT                   L"lewo" // left ___
...
#define LOCALIZED_ALTERNATE_LT                     L"lw" // lt ___
...
#define LOCALIZED_ALTERNATE_PENUP                  L"podnie?" // penup ___
...
#define LOCALIZED_ALTERNATE_PU                     L"pod" // pu ___
...
#define LOCALIZED_ALTERNATE_REPEAT                 L"powt?rz" // repeat ___
#define LOCALIZED_ALTERNATE_RERANDOM               L"rerandom" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_RIGHT                  L"prawo" // right ___
...
#define LOCALIZED_ALTERNATE_RT                     L"pw" // rt ___
...
#define LOCALIZED_ALTERNATE_SETFC                  L"ukm" // setfc ___
#define LOCALIZED_ALTERNATE_SETFLOODCOLOR          L"ustalKolMal" // setfloodcolor ___
...
#define LOCALIZED_ALTERNATE_SETPC                  L"ukp" // setpc ___
#define LOCALIZED_ALTERNATE_SETPENCOLOR            L"ustalKolPis" // setpencolor ___
#define LOCALIZED_ALTERNATE_SETPENPATTERN          L"setpenpattern" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_SETPENSIZE             L"ustalGrubo??" // setpensize ___
...
#define LOCALIZED_ALTERNATE_SETSCREENCOLOR         L"ustalKolorT?a" // setscreencolor ___
...
#define LOCALIZED_ALTERNATE_SHOWTURTLE             L"poka?mnie" // showturtle ___
...
#define LOCALIZED_ALTERNATE_SQRT                   L"pwk" // sqrt ___
#define LOCALIZED_ALTERNATE_SS                     L"ss" // NOT_YET_LOCALIZED
#define LOCALIZED_ALTERNATE_ST                     L"p?" // st ___
...
#define LOCALIZED_ALTERNATE_TO                     L"oto" // to ___
...
#define LOCALIZED_GENERAL_CANCELBUTTON  L"Anuluj" // Cancel
#define LOCALIZED_GENERAL_APPLYBUTTON   L"Zastosuj" // &Apply

#define LOCALIZED_GENERAL_PRODUCTNAME   L"FMSLogo"

// Embedded description of fmslogo.exe
#define LOCALIZED_FMSLOGO_FILE_DESCRIPTION  L"?rodowisko programistyczne FMSLogo"

//
// The menu options on the main window 
//
#define LOCALIZED_FILE                  L"&Plik" // &File
#define LOCALIZED_FILE_NEW              L"Nowy\t(czy?ci przestrze? robocz?)" // &New\t(erase workspace)
#define LOCALIZED_FILE_LOAD             L"Za?aduj...\t(do??cza do przestrzeni roboczej)" // &Load...\t(merge into workspace)
#define LOCALIZED_FILE_OPEN             L"Otw?rz...\t(zast?puje przestrze? robocz?)" //&Open...\t(replace workspace)
#define LOCALIZED_FILE_SAVE             L"Zapisz" // &Save
#define LOCALIZED_FILE_SAVEAS           L"Zapisz jako..." // Save &As...
#define LOCALIZED_FILE_SETASSCREENSAVER L"Ustaw jako wygaszacz ekranu" // Se&t As Screen Saver
#define LOCALIZED_FILE_EDIT             L"Edycja..." // &Edit...
#define LOCALIZED_FILE_ERASE            L"Usuwanie..." // E&rase...
#define LOCALIZED_FILE_EXIT             L"Koniec" // E&xit

#define LOCALIZED_BITMAP               L"&Bitmapa" // &Bitmap
#define LOCALIZED_BITMAP_NEW           L"Nowa" // &New
#define LOCALIZED_BITMAP_LOAD          L"Za?aduj..." // &Load...
#define LOCALIZED_BITMAP_SAVE          L"Zapisz" // &Save
#define LOCALIZED_BITMAP_SAVEAS        L"Zapisz jako..." // Save &As...
#define LOCALIZED_BITMAP_PRINT         L"Wydrukuj..." // &Print...
#define LOCALIZED_BITMAP_PRINTERSETUP  L"Ustawienia drukarki..." // P&rinter Setup...
#define LOCALIZED_BITMAP_ACTIVEAREA    L"Obszar aktywny..." // A&ctive Area...

#define LOCALIZED_SET                  L"&Ustawienia" // &Set
#define LOCALIZED_SET_PENSIZE          L"Rozmiar pisaka" // Pen Si&ze...
#define LOCALIZED_SET_LABELFONT        L"Czcionka napis?w..." // &Label Font...
#define LOCALIZED_SET_COMMANDERFONT    L"Czcionka linii komend..." // &Commander Font...
#define LOCALIZED_SET_PENCOLOR         L"Kolor pisaka..." // &Pen Color...
#define LOCALIZED_SET_FLOODCOLOR       L"Kolor malowania..." // F&lood Color...
#define LOCALIZED_SET_SCREENCOLOR      L"Kolor t?a..." // &Screen Color...

#define LOCALIZED_ZOOM                 L"Po&wi?kszenie" // &Zoom
#define LOCALIZED_ZOOM_IN              L"Po&wi?ksz" // &In
#define LOCALIZED_ZOOM_OUT             L"Po&mniejsz" // &Out
#define LOCALIZED_ZOOM_NORMAL          L"Rozmiar &pocz?tkowy" // &Normal

#define LOCALIZED_HELP                 L"Po&moc" // &Help
#define LOCALIZED_HELP_INDEX           L"Indeks" // &Index
#define LOCALIZED_HELP_TUTORIAL        L"Podr?cznik" // &Tutorial
#define LOCALIZED_HELP_DEMO            L"Prezentacja" // &Demo
#define LOCALIZED_HELP_EXAMPLE         L"Przyk?ady" // &Examples
#define LOCALIZED_HELP_RELEASENOTES    L"Uwagi do wydania" // &Release Notes
#define LOCALIZED_HELP_ABOUTFMSLOGO    L"O " LOCALIZED_GENERAL_PRODUCTNAME "..." // &About LOCALIZED_GENERAL_PRODUCTNAME...
#define LOCALIZED_HELP_MS              L"O MS..." // &About MS...
...
#define LOCALIZED_HELP_LANGTOENGLISH   L"Polski -> Angielski"
#define LOCALIZED_HELP_ENGLISHTOLANG   L"Angielski -> Polski"

// The "Set Active Area" dialog box
#define LOCALIZED_SELECTACTIVEAREA              L"Wybierz obszar aktywny" // Select Active Area
#define LOCALIZED_SELECTACTIVEAREA_EFFECT       L"Parametry do wydruku oraz zapisu bitmapy" // These affect Printing and Saving Bitmaps
#define LOCALIZED_SELECTACTIVEAREA_YHIGH        L"Y g?ra" // Y-High xxx
#define LOCALIZED_SELECTACTIVEAREA_YLOW         L"Y d??" // Y-Low xxx
#define LOCALIZED_SELECTACTIVEAREA_XHIGH        L"X prawa" // X-High xxx
#define LOCALIZED_SELECTACTIVEAREA_XLOW         L"X lewa" // X-Low xxx
#define LOCALIZED_SELECTACTIVEAREA_STEPSPERINCH L"Liczba krok?w ???wia na 1 cal wydruku" // Turtle steps per inch printed: //?
#define LOCALIZED_SELECTACTIVEAREA_RESET        L"Domy?lnie" // &Reset
...
#define LOCALIZED_SCREENSAVER_DESCRIPTION       L"Wygaszacz ekranu FMSLogo" // FMSLogo Screensaver
#define LOCALIZED_SCREENSAVER_SETTINGS_TITLE    L"W?a?ciwo?ci wygaszacza ekranu FMSLogo" // FMSLogo Screensaver Settings
#define LOCALIZED_SCREENSAVER_LOCATE            L"Lokalizacja..." // &Locate ... xxx
#define LOCALIZED_SCREENSAVER_FILE              L"Plik programu Logo:" // Logo &File:
...
#define LOCALIZED_EMPTYWORKSPACE_MESSAGE              L"?adne procedury, zmienne, czy listy w?a?ciwo?ci nie s? zdefiniowane\ni zapisana przestrze? robocza b?dzie plikiem pustym.\n\nCzy nadal chcesz dokona? zapisu przestrzeni roboczej?" // There are no procedures, variables, or property lists defined,\nso the workspace will be saved as an empty file.\n\nDo you want to save the workspace anyway?

//
// Menu options in the popup menu
//
#define LOCALIZED_POPUP_COPY                     L"Kopiuj" // Copy
#define LOCALIZED_POPUP_CUT                      L"Wytnij" // Cut
#define LOCALIZED_POPUP_PASTE                    L"Wklej" // Paste
#define LOCALIZED_POPUP_DELETE                   L"Usu?" // Delete
#define LOCALIZED_POPUP_UNDO                     L"Cofnij" // Undo
#define LOCALIZED_POPUP_REDO                     L"Przywr??" // Redo
#define LOCALIZED_POPUP_SELECTALL                L"Zaznacz wszystko" // Select All
#define LOCALIZED_POPUP_HELP                     L"Znajd? temat" // Topic Search
#define LOCALIZED_POPUP_REMOVELINES              L"Usu? zaznaczone linie" // Remove Selected Lines

//
// The menu options on the editor
//
#define LOCALIZED_EDITOR_TITLE                   L"Edytor" // Editor

#define LOCALIZED_EDITOR_FILE                    L"Plik" // &File
#define LOCALIZED_EDITOR_FILE_SAVEANDEXIT        L"Zapisz i wyjd?\tCtrl+D" // &Save and Exit\tCtrl+D
#define LOCALIZED_EDITOR_FILE_SAVETOWORKSPACE    L"Zapisz do obszaru roboczego" // Save to &Workspace
#define LOCALIZED_EDITOR_FILE_PRINT              L"Wydrukuj..." // &Print...
#define LOCALIZED_EDITOR_FILE_EXIT               L"Wyjd?" // E&xit

#define LOCALIZED_EDITOR_EDIT                    L"Edycja" // &Edit
#define LOCALIZED_EDITOR_EDIT_UNDO               L"Cofnij\tCtrl+Z" // &Undo\tCtrl+Z
#define LOCALIZED_EDITOR_EDIT_REDO               L"Przywr??\tCtrl+Y" // &Redo\tCtrl+Y
#define LOCALIZED_EDITOR_EDIT_CUT                L"Wytnij\tCtrl+X" // &Cut\tCtrl+X
#define LOCALIZED_EDITOR_EDIT_COPY               L"Kopiuj\tCtrl+C" // C&opy\tCtrl+C
#define LOCALIZED_EDITOR_EDIT_PASTE              L"Wklej\tCtrl+V" // &Paste\tCtrl+V
#define LOCALIZED_EDITOR_EDIT_DELETE             L"Usu?\tDel" // &Delete\tDel
#define LOCALIZED_EDITOR_EDIT_CLEARALL           L"Usu? wszystko\tCtrl+Del" // C&lear All\tCtrl+Del
#define LOCALIZED_EDITOR_EDIT_SELECTALL          L"Zaznacz wszystko\tCtrl+A" // S&elect All\tCtrl+A

#define LOCALIZED_EDITOR_SEARCH                  L"Wyszukiwanie" // &Search
#define LOCALIZED_EDITOR_SEARCH_FIND             L"Znajd?...\tCtrl+F" // &Find...\tCtrl+F
#define LOCALIZED_EDITOR_SEARCH_REPLACE          L"Zamie?...\tCtrl+H" // &Replace...\tCtrl+H
#define LOCALIZED_EDITOR_SEARCH_NEXT             L"Znajd? nast?pny\tF3" // &Next\tF3

#define LOCALIZED_EDITOR_SET                     L"Ustawienia" // Se&t
#define LOCALIZED_EDITOR_SET_FONT                L"Czcionka..." // &Font...

#define LOCALIZED_EDITOR_TEST                    L"Testowanie"
#define LOCALIZED_EDITOR_TEST_RUN_SELECTION      L"Uruchom zaznaczone\tCtrl+R" // &Run Selection\tCtrl+R

#define LOCALIZED_EDITOR_HELP                    L"Pomoc" // &Help
#define LOCALIZED_EDITOR_HELP_INDEX              L"Indeks" // &Index
#define LOCALIZED_EDITOR_HELP_EDITOR             L"Edytor" // &Editor
#define LOCALIZED_EDITOR_HELP_TOPICSEARCH        L"Znajd? temat\tF1" // &Topic Search\tF1
...
#define LOCALIZED_UNSAVEDCHANGES_SAVEANDEXIT    L"Zapisz i wyjd?" // &Save and Exit
#define LOCALIZED_UNSAVEDCHANGES_DONTSAVE       L"Nie zapisuj" // &Don't Save
#define LOCALIZED_UNSAVEDCHANGES_CANCEL         LOCALIZED_GENERAL_CANCELBUTTON
#define LOCALIZED_UNSAVEDCHANGES_MESSAGE1       L"Przestsze? robocza zawiera niezapisane zmiany. Je?li wyjdziesz bez zapisu, to zmiany te zostan? utracone." // There are unsaved changes in the workspace. If you exit without saving, these changes will be lost.
#define LOCALIZED_UNSAVEDCHANGES_MESSAGE2       L"Czy chcesz zapisa? zmiany przed wyj?ciem?" // Would you like to save your changes before exiting?
...
#define LOCALIZED_COMMANDER_HALT                L"Halt" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_TRACE               L"Trace" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_NOTRACE             L"NoTrace" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_PAUSE               L"Pause" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_STATUS              L"Status" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_NOSTATUS            L"NoStatus" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_STEP                L"Step" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_UNSTEP              L"UnStep" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_RESET               L"Czy??" // Reset
#define LOCALIZED_COMMANDER_EXECUTE             L"Execute" // NOT_YET_LOCALIZED
#define LOCALIZED_COMMANDER_EDALL               L"Edall" // NOT_YET_LOCALIZED

//
// Strings on the Status window
//
#define LOCALIZED_STATUS                        L"Status" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_PEN                    L"Pisak" // Pen
#define LOCALIZED_STATUS_CONTACT                L"Contact:" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_WIDTH                  L"Rozmiar:" // Width:
#define LOCALIZED_STATUS_STYLE                  L"Styl:" // Style:
#define LOCALIZED_STATUS_ORIENTATION            L"Orientation" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_PITCH                  L"Pitch:" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_HEADING                L"Heading:" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_ROLL                   L"Roll:" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_TURTLE                 L"Turtle" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_POSITION               L"Position(XYZ):" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_WHICH                  L"Which:" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_VISIBILITY             L"Visibility:" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_COLOR                  L"Color" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_PENCOLOR               L"Pen(RGB):" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_FLOODCOLOR             L"Flood(RGB):" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_SCREENCOLOR            L"Screen(RGB):" // NOT_YET_LOCALIZED
...
#define LOCALIZED_STATUS_PENERASE       L"Erase" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_PENUP          L"Up" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_PENDOWN        L"Down" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_PENSHOWN       L"Shown" // NOT_YET_LOCALIZED
#define LOCALIZED_STATUS_PENHIDDEN      L"Hidden" // NOT_YET_LOCALIZED
...
#define LOCALIZED_SELECTPROCEDURE_ALL           L"Wszystkie" // &All xxx
#define LOCALIZED_ERASEPROCEDURE                L"Wyczy?? procedur?" // Erase Procedure
#define LOCALIZED_EDITPROCEDURE                 L"Edytuj procedur?" // Edit Procedure


//
// Strings on the Color Picker Dialog box
//
#define LOCALIZED_SETCOLOR                     L"Ustal kolor" // Set Color
#define LOCALIZED_SETCOLOR_PENCOLOR            L"Kolor pisaka" // Pen Color
#define LOCALIZED_SETCOLOR_FLOODCOLOR          L"Kolor malowania" // Flood Color
#define LOCALIZED_SETCOLOR_SCREENCOLOR         L"Kolor t?a" // Screen Color
#define LOCALIZED_SETCOLOR_RED                 L"R (czerwony)" // Red
#define LOCALIZED_SETCOLOR_GREEN               L"G (zielony)" // Green
#define LOCALIZED_SETCOLOR_BLUE                L"B (niebieski)" // Blue
...
//
#define LOCALIZED_SETPENSIZE                   L"Rozmiar pisaka" // Pen Size
#define LOCALIZED_SETPENSIZE_SIZE              L"Grubo??" // Thickness
...
#define LOCALIZED_FILEFILTER_ALLFILES L"Wszystkie pliki (*.*)|*.*" // All Files
#define LOCALIZED_FILEFILTER_LOGO     L"Pliki Logo (*.lgo)|*.lgo|" LOCALIZED_FILEFILTER_ALLFILES // Logo Files
#define LOCALIZED_FILEFILTER_IMAGE    L"Bitmapy (*.bmp)|*.bmp|Grafiki GIF (*.gif)|*.gif|" LOCALIZED_FILEFILTER_ALLFILES // Bitmap Files|GIF Files
...
#define LOCALIZED_ERROR_BADDATA                L"%p doesn't like %s as input" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_DIDNTOUTPUT            L"%p didn't output to %p" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_NOTENOUGHINPUTS        L"not enough inputs to %p" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_TOOMUCH                L"too much inside ()'s" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_DONTSAYWHATTODOWITH    L"You don't say what to do with %s" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_PARENMISMATCH          L"too many ('s" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_NOVALUE                L"%s has no value" // NOT_YET_LOCALIZED
...
#define LOCALIZED_ERROR_DONTKNOWHOWTO          L"I don't know how to %p" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_NOCATCHTAG             L"Can't find catch tag for %p" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_ALREADYDEFINED         L"%p is already defined" // NOT_YET_LOCALIZED
...
#define LOCALIZED_ERROR_TONOTINSIDE            L"Can't use TO inside a procedure" // NOT_YET_LOCALIZED
...
//
#define LOCALIZED_ERROR                      L"Error" // NOT_YET_LOCALIZED
...
#define LOCALIZED_ERROR_WINDOWALREADYEXISTS   L"%s already exists" // NOT_YET_LOCALIZED
#define LOCALIZED_ERROR_WINDOWDOESNOTEXIST    L"%s does not exist" // NOT_YET_LOCALIZED
...
#define LOCALIZED_EDITOR_TITLE_FIND     L"Znajd?" // Find
#define LOCALIZED_EDITOR_TITLE_REPLACE  L"Zamie?" // Replace

//
// The text that's displayed when the Editor's Search->Find fails.
//
#define LOCALIZED_STRINGTABLE_CANNOTFINDSTRING L"Nie znaleziono: %s" // Cannot find %s
...
#define LOCALIZED_COLOR_BLACK                 L"czarny" // Black
#define LOCALIZED_COLOR_BLANCHEDALMOND        L"BlanchedAlmond" // NOT_YET_LOCALIZED
#define LOCALIZED_COLOR_BLUE                  L"niebieski" // Blue
...
#define LOCALIZED_COLOR_GREEN                 L"zielony" // Green
#define LOCALIZED_COLOR_GREENYELLOW           L"GreenYellow" // NOT_YET_LOCALIZED
#define LOCALIZED_COLOR_GREY                  L"szary" // Grey
...
#define LOCALIZED_COLOR_LIGHTGRAY             L"jasnoszary" // LightGray
...
#define LOCALIZED_COLOR_PINK                  L"r??owy" // Pink
...
#define LOCALIZED_COLOR_WHITE                 L"bia?y" // White
#define LOCALIZED_COLOR_WHITESMOKE            L"WhiteSmoke" // NOT_YET_LOCALIZED
#define LOCALIZED_COLOR_YELLOW                L"???ty" // Yellow
